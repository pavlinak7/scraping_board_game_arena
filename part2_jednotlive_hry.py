...
if doplnit.empty:
    ...
    df_results = main(driver_path, chrome_options, login_url, email, password, doplnit.url.to_list())
    updated_games = update_completed_games(tournaments, df_results)
    create_table(typ_hry_aktual_table)
    load_csv_to_db(typ_hry_aktual_table, '/home/pavlina/Dokumenty/IT/portfolio/scraping_bga_nejnovejsi/ukoncene_hry/aktualizace/tournaments2.csv')
